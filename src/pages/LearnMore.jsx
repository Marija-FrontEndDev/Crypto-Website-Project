...
const LearnMore = () => {
  ...
  <h4>What is cryptocurrency?</h4> <br/>
...
You can buy cryptocurrency using a crypto exchange or through certain broker-dealers. Once you own it, you can store, manage, and even buy or sell your crypto in a wallet. <br/>
      ...
      <p className='pressOn'>If you’re interested in learning more about cryptocurrency, press on <button id="top" className='btninlearn'> <Link to="/get-started">Get Started</Link> </button></p>
    </div>
  )
}
